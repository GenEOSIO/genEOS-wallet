...
let {PrivateKey} = require('geneosjs-ecc');
...
describe('Identity', () => {
    ...
    const accountFields = {
        accounts:[
            {blockchain:Blockchains.GENEOS, host:'127.0.0.1', port:8888},
