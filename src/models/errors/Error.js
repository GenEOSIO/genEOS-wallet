...
export default class Error {
    ...
    static locked(){
        return new Error(ErrorTypes.LOCKED, "The user's genEOS Wallet is locked. They have been notified and should unlock before continuing.")
    }
    ...
    static requiresUpgrade(){
        return new Error(ErrorTypes.UPGRADE_REQUIRED, "The required version is newer than the User's genEOS Wallet", ErrorCodes.UPGRADE_REQUIRED)
    }
    ...
    static usedKeyProvider(){
        return new Error(
            ...
            "Do not use a `keyProvider` with a genEOS Wallet. Use a `signProvider` and return only signatures to this object. A malicious person could retrieve your keys otherwise.",
