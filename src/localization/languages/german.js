...
export default {
    ...
    [KEYS.KEYPAIR_Description]:`
        Hier kannst du genEOS-Schlüsselpaare erzeugen. Die erzeugten Schlüsselpaare werden lokal auf deinem Rechner erzeugt und werden nie versendet.
    ...
    [KEYS.ALERT_NetworkHostInvalid]:[
        ...
        ( z.B: testnet.geneos.io) oder eine IP ( z.B: 192.168.0.1 ) sein.`
    ],
    //2
