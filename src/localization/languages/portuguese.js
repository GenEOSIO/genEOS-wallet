...
export default {
    ...
    [KEYS.BUTTON_CreateNewScatter]:'Criar Novo genEOS Wallet',
    ...
    [KEYS.KEYPAIR_Description]:`
        Você pode usar este painel para gerar pares de chaves genEOS. Estes pares de chaves são gerados localmente na sua máquina
    ...
    [KEYS.ALERT_NetworkHostInvalid]:[
        ...
        `O host da rede que você inseriu era inválido. Os hosts devem ser um nome de domínio
         ( ex: testnet.geneos.io ) ou um IP ( ex: 192.168.0.1 ).`
    ],
