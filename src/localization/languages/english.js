...
export default {
    ...
    [KEYS.BUTTON_DestroyScatter]:'Destroy genEOS Wallet',
    [KEYS.BUTTON_CreateNewScatter]:'Create New genEOS Wallet',
    [KEYS.BUTTON_LoadFromBackup]:'Load From Backup',
    [KEYS.BUTTON_Unlock]:'Unlock',
    [KEYS.BUTTON_ExportScatter]:'Export genEOS Wallet',
    ...
    [KEYS.HISTORIES_Description]:`
        Once you have them, you will be able to see a list of all of the events that pass through your genEOS Wallet.
        What you will not see is events that occurred on your accounts outside of genEOS Wallet.
     `,
    [KEYS.HISTORIES_Note]:`
        Note: Exporting your genEOS Wallet data from the backup option in the settings panel does not save these events.
        When you import that genEOS Wallet instance again your histories will be empty. If you would like to export your histories
    ...
    [KEYS.BACKUP_Description]:`
        Exporting your genEOS Wallet allows you to import it into other devices. The file will still be encrypted when it is 
    ...
    [KEYS.IMPORT_Description]:`
        Importing your encrypted keychain file will rebuild you genEOS Wallet keychain but it will not import your old networks or 
        accounts. 
    `,
    ...
    [KEYS.DESTROY_Header]:`Destroying genEOS Wallet`,
    [KEYS.DESTROY_Description]:`
        You are about to destroy your entire genEOS Wallet keychain. The only way to get this exact genEOS Wallet back is by 
        importing an exported genEOS Wallet JSON. You will not be able to claim your identities otherwise. Make sure you 
        have exported your genEOS Wallet from the backup settings panel before hand.
    `,
    ...
    `,
    [KEYS.KEYPAIR_Important]:`Save your private key elsewhere! You can not take private keys back out of genEOS Wallet.`,
    ...
    [KEYS.LOCK_Description]:`
        Auto Lock handles genEOS Wallet's locking for you so that you don't have to 
        remember to lock your genEOS Wallet when you step away.
    `,
    ...
    [KEYS.MNEMONIC_Description]:`Mnemonics in genEOS Wallet are only used for password recovery.`,
    [KEYS.MNEMONIC_Note]:`
        Be sure to save yours somewhere safe. It is the only way to regain access to your 
        genEOS Wallet and decrypt your private information if you forget your password.
    `,
    ...
    [KEYS.ALERT_NoAccountsFound]:[
        ...
        `No accounts were found connected to this private/public key. Make sure there is an GENEOS account linked to this public key on the GENEOS network.`
    ],
    //2
    ...
    [KEYS.ALERT_NetworkHostInvalid]:[
        ...
        `The Network host you entered was invalid. Hosts should be either a domain name
         ( ex: testnet.geneos.io ) or an IP ( ex: 192.168.0.1 ).`
    ],
    //2
    ...
    [KEYS.ALERT_RemovingEndorsedNetwork]:[
        ...
        `You cannot remove genEOS Wallet's endorsed Networks.`
    ],
    //2
    ...
    [KEYS.REQUEST_AddNetwork]:[
        /*{DOMAIN}*/ 'wants to add their network to your genEOS Wallet.',

        'Some applications use their own Networks.',

        `This in no way gives the application any access to your genEOS Wallet. 
    ...
    [KEYS.REQUEST_ScatterIsLocked]:[
        `Your genEOS Wallet is locked!`,

        `Before you can do anything with your genEOS Wallet you will need to unlock it.`,
        ...
        `If you see a prompt/popup which is requesting your password, it is a malicious website trying to get your password.
         Always only unlock genEOS Wallet from the extension's popup by clicking on the icon in your browser tray.`
    ],
    //4
    [KEYS.REQUEST_UpdateVersion]:[
        `Your genEOS Wallet is out of date!`,

        /*{DOMAIN}*/ `is requiring you have a version of genEOS Wallet that is newer than the one installed.`,
        ...
        `Please Note, we leave version checking up to the applications themselves. They could be maliciously trying to
         get you to download something. Make sure you always download genEOS Wallet from the proper location.`
    ],
