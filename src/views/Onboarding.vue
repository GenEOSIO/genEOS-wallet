    ...
    <section>
        ...
        <section v-if="step == 0">
            <section class="white-bg">
                <figure class="title">Welcome to genEOS Wallet!</figure>
                ...
                <figure class="description">
                    ...
                    and recognize yourself as the sole legal owner of your own genEOS Wallet instance, your keys, and your data.
                </figure>
            </section>
            <section class="p20">
        ...
        <section v-if="step == 1">
            <section class="white-bg">
                ...
                <figure class="breaker"></figure>
                <figure class="description">
                    genEOS supports multiple blockchains. When you enter your Key Pair we will determine which
        ...
        <section v-if="step == 2">
            <section class="white-bg">
                ...
                <figure class="breaker"></figure>
                <figure class="description">
                    You now have a genEOS Wallet Identity with an {{keypair.blockchain.toUpperCase()}} account linked to it.
                    <br><br>
