        ...
        <section v-if="!scatter.settings.hasEncryptionKey">
            <section class="p20">
                <form v-on:submit.prevent="create">
                  ...
                  <btn class="btnnew" :text="locale(langKeys.BUTTON_CreateNewScatter)" type="submit" margined="true"></btn>
                </form>
            </section>
            <figure class="line"></figure>
            <section class="p20">
                <btn class="btnbackup" :text="locale(langKeys.BUTTON_LoadFromBackup)" v-on:clicked="importKeychain"></btn>
            </section>
        </section>
        <section v-else>
            <section class="p20" style="overflow:hidden;">
                <section class="unlocker" :class="{'hiding':hiding}">
                    <form v-on:submit.prevent="unlock">
                      ...
                      <btn class="btnunlock" :text="locale(langKeys.BUTTON_Unlock)" type="submit" margined="true"></btn>
                    </form>
                </section>
            </section>
        </section>
